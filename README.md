...
- `is_deleted` может принимать значение 0 или 1
  - 0 (по умолчанию) - вопрос видим пользователям, доступен к редактированию
  - 1 - вопрос недоступен к просмотру/редактированию
### Versioned
- `is_deleted` может принимать значение 0 или 1
  - 0 (по умолчанию) - вопрос видим пользователям, доступен к редактированию
  - 1 - вопрос недоступен к просмотру/редактированию
...
- Староста академической группы (Group Admin):
    ...
    - Блокировать участников группы (см. ["Блокирование участника группы"](#9-блокирование-участника-группы))
...
Староста обладает возможностью исключения участника из группы. В таком случае исключённый участник более не относится ни к одной из академических групп и имеет возможность просматривать и комментировать только общедоступные списки вопросов.
